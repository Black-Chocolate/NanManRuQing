...
parser.add_argument('--trained_model', default='weights/XRay.pth',
                    type=str, help='Trained state_dict file path to open')
...
def test_x_ray():
    ...
    # load data
    test_set = SIXrayDetection(root=args.xray_root, image_sets=None,
                               transform=BaseTransform(x_ray['min_dim'], MEANS))
    if args.cuda:
        net = net.cuda()
